...
window.PageTurn = (function ($) {
    ...
    Base.prototype = {
        ...
        * */
        renderPage: function (current, init) {
            var This = this,
                $first,
                $last,
                $prevMore,
        ...
        renderSkip: function () {
            var str =
                '<span class="page-skip">\
                    <label class="lang-PTurnReach">到第</label>\
                    <input type="text" class="page-input" />\
                    <label class="lang-PTurnPage">页</label>\
                    <button type="button" class="lang-PTurnDetermine page-btn">确定</button>\
                </span>'
        ...
        * */
        reload: function (current, totalPage) {
            var This = this
